-- Migration: Surface banks/customers with ZERO tickets in the selected period,
-- so management can see who never opened a ticket (adoption/engagement gap).
-- Only visible to internal roles (bank users only ever see their own data anyway).
