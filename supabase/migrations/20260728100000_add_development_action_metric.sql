-- Migration: Add a dedicated "development_action_tickets" metric to the dashboard
-- analytics RPC, so the Overview page can show a filter/count card for tickets
-- currently escalated to a specialized team (DEVELOPMENT_ACTION status).
